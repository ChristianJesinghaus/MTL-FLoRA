...
<h5 align="center"><em>Authors redacted for double blind</em>
</h5>
</br>
...
The main branch of this repository implements **Approach II** on the [TinyLlama-1.1B-Chat-v1.0](https://huggingface.co/johnsnowlabs/tinyllama-1.1b-Chat-v1.0) causal language model. All paper experiments for this approach (excluding the `freeze-R` ablation) are included. Freeze-R can be found on the "freezeR" branch. The RoBERTa experiments can be found on the FedMTL-LoRA Branch and FLoRA-B_w-stacking branch, where FedMTL-LoRA bears the averaged-w variant and the FLoRA-B_w-stacking branch contains the clean stacking variant of approach I.
